...
export function buildSessionDirective(source, eventMeta) {
  ...
  block += `\n<session_search>`;
  block += `\nDetailed session data is indexed in a8-cortex FTS5 (source: "session-events").`;
  block += `\nUse mcp__plugin_a8-cortex_a8-cortex__cm_search(queries: [...], source: "session-events") when you need specifics.`;
  block += `\nDo NOT call cm_index() — data is already indexed.`;
  block += `\n</session_search>`;
